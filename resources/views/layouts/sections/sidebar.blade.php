<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- <div class=" mt-3 pb-2 mb-3 d-flex pl-5">
        <a href="/" class="brand-link mx-auto">
            <img src="/dist/img/logo_tapmart.png" alt="TappMart Logo" class="brand-image" style="opacity: .8">
        </a>
    </div> -->
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="user-panel  pb-1   d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block pl-4"><b>{{ Auth::user()->name }}</b></a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="/merchant_category" class="nav-link">
                        <i class="nav-icon fas fa-th"></i>
                        <p>
                            Merchant Category
                        </p>
