                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <span style="float: left; margin-top: -5px; padding-right: 2px;">
                                    <a href="/save_category" class="btn  btn-primary btn-sm">Add
                                        Category</a>
                                </span>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $category['id'] }}</td>
                                    <td>{{ $category['name'] }}</td>
                                    <td>{{ $category['tappsure'] }}</td>
                                    <td>
                                        @if($category['image'])
                                        <img src="{{$category['image'] }}" width=" 60" alt="img">
                                        @else
                                    ...
                                    <td class="text-center"><a class="btn btn-primary btn-sm"
                                            href="/update_category/{{ $category['id'] }}">
                                            Update</a>
                                        <a class=" btn btn-danger btn-sm"
                                            href="/delete_category/{{ $category['id'] }}">Delete</a>
                                    </td>
